...
namespace BlooDyWeb.Migrations
{
    ...
    [Migration("20240730230522_AjoutTransfusionModule")]
    partial class AjoutTransfusionModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlooDyWeb.Models.TransfusionModule.Beneficiaire", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("PersonneContactId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BlooDyWeb.Models.TransfusionModule.Medecin", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BlooDyWeb.Models.TransfusionModule.Transfusion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("BeneficiaireId")
                        .HasColumnType("bigint");

                    b.Property<long>("ComposanteId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime?>("DateTransfusion")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BlooDyWeb.Models.TransfusionModule.Transfusion", b =>
                {
                    b.HasOne("BlooDyWeb.Models.TransfusionModule.Beneficiaire", "Beneficiaire")
                        .WithMany()
                        .HasForeignKey("BeneficiaireId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlooDyWeb.Models.Stock.Composante", "Composante")
                        .WithMany()
                        .HasForeignKey("ComposanteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlooDyWeb.Models.TransfusionModule.Medecin", "Medecin")
                        .WithMany()
